...
title: 主题食用方法
sticky: 1
description: 记录主题的一些配置信息
tag: 配置
---
# 首页&文章

<code>home</code>: 首页的配置
<code>Article</code>: 文章的配置
...
### layout
调整主页的部分内容
指定<code>layout</code>为<code>home</code>,在<code>/index.md</code>中进行配置
